<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:54:"F:\wwwroot\2019\kfht.net/app/www\view\index\about.html";i:1555480762;s:55:"F:\wwwroot\2019\kfht.net\app\www\view\public\cssjs.html";i:1555479545;s:56:"F:\wwwroot\2019\kfht.net\app\www\view\public\header.html";i:1555313358;s:56:"F:\wwwroot\2019\kfht.net\app\www\view\public\footer.html";i:1555480617;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title><?php echo $list['title']; ?>-关于我们-<?php echo config('site.name'); ?></title>
...
<div class="inBanner in1">
    <div class="inHeader">
        <div class="pageName wow bounceInRight">关于我们</div>
        <div class="inMenu wow fadeIn">
            <li <?php if($list['id'] == '1'): ?>class="active"<?php endif; ?>><a href="<?php echo url('index/about','id=1'); ?>">公司概况</a></li>
            <li <?php if($list['id'] == '2'): ?>class="active"<?php endif; ?>><a href="<?php echo url('index/about','id=2'); ?>">企业文化</a></li>
            <li <?php if($list['id'] == '3'): ?>class="active"<?php endif; ?>><a href="<?php echo url('index/about','id=3'); ?>">发展历程</a></li>
        </div>
    </div>    
</div>
...
<input type="hidden" id="activeMenu" value="about" />
<div class="footerBg">
	<div class="footer">
		<li>
