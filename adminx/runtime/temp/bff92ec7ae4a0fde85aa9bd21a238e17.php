<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"I:\wwwroot\layuiAdmin-iframe\adminx/application/view\article\index.html";i:1555863606;s:64:"I:\wwwroot\layuiAdmin-iframe\adminx\application\view\layout.html";i:1555852192;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="layui-fluid">
   <div class="layui-card">
    ...
    <div class="layui-card-body">
        ...
        <table id="LAY-app-content-list" class="my-table" lay-method="post" lay-url="<?php echo url('article/index'); ?>" lay-filter="LAY-app-content-list"></table>
